...
public class DBService {
    ...
    public void instanciaDB() {
        ...
        Tecnico t1 = new Tecnico(null, "Paulo", "paulo@tre-rr.jus.br", "67794882591",  encoder.encode("12345678"));
        t1.addPerfil(Perfil.ADMIN);

        Tecnico t2 = new Tecnico(null, "Rafael", "rafael@tre-rr.jus.br", "301.168.430-80", encoder.encode("31313213"));
        t2.addPerfil(Perfil.TECNICO);

        Tecnico t3 = new Tecnico(null, "Juliano", "conhecer.ti@tre-rr.jus.br", "685.103.800-58", encoder.encode("31313213"));
        t2.addPerfil(Perfil.TECNICO);

        Cliente cl1 = new Cliente(null, "Linux Torvalds", "linux@torvalds.com", "176.221.150-53", encoder.encode("12345678"));
        Cliente cl2 = new Cliente(null, "Santos", "stic@tre-rr.jus.br", "586.077.060-04", encoder.encode("25452"));
